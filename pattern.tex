...
\begin{bnf}
\nonterminal{ObjectPattern} \br
    \terminal{\{} ObjectPatternBody \terminal{\}}
\end{bnf}

\begin{bnf}
\nonterminal{ObjectPatternBody} \br
    ObjectItem \bnflp\terminal{,} ObjectItem\bnfrp\bnfs
\end{bnf}

\begin{bnf}
\nonterminal{ObjectItem} \br
...
\begin{bnf}
\nontermdef{ArrayPatternBind} \br
    \terminal{[} AnyPatternBind \bnflp\terminal{,} AnyPatternBind\bnfrp\bnfs \terminal{]}
\end{bnf}

\begin{bnf}
\nontermdef{TuplePatternBind} \br
    \terminal{(} AnyPatternBind \bnflp\terminal{,} AnyPatternBind\bnfrp\bnfs \terminal{)}
\end{bnf}

\begin{bnf}
\nontermdef{AnyPatternBind} \br
    PatternBind \br
    \terminal{...} \br
    NullPattern \br
    ExprPattern
...
\begin{bnf}
    \nonterminal{ObjectPatternBind} \br
        \terminal{\{} ObjectPatternBodyBind \terminal{\}}
    \end{bnf}

    \begin{bnf}
    \nonterminal{ObjectPatternBodyBind} \br
        ObjectItemBind \bnflp\terminal{,} ObjectItemBind\bnfrp\bnfs
    \end{bnf}

    \begin{bnf}
    \nonterminal{ObjectItemBind} \br
