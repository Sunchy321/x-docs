...
\tcode{false}     & \tcode{finally}   & \tcode{float}     & \tcode{for}       & \tcode{func}      \\
\tcode{if}        & \tcode{impl}      & \tcode{import}    & \tcode{in}        & \tcode{init}      \\
\tcode{infer}     & \tcode{int}       & \tcode{internal}  & \tcode{is}        & \tcode{lazy}      \\
\tcode{let}       & \tcode{macro}     & \tcode{match}     & \tcode{mut}       & \tcode{never}     \\
