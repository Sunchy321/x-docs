...
\tcode{class}     & \tcode{cmp}       & \tcode{const}     & \tcode{continue}  & \tcode{defer}     \\
\tcode{do}        & \tcode{dyn}       & \tcode{else}      & \tcode{enum}      & \tcode{extern}    \\
\tcode{false}     & \tcode{float}     & \tcode{for}       & \tcode{func}      & \tcode{if}        \\
\tcode{impl}      & \tcode{import}    & \tcode{in}        & \tcode{infer}     & \tcode{init}      \\
