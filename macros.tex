...
\lstdefinelanguage{X} {
    morekeywords={void, never, int, uint, float, bool, string, self, mut, const, some, any, infer, dyn},
    ...
    morekeywords={operator, init, deinit, import, macro, throw, try, catch, finally},
